    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='houses.Areas', verbose_name='归属地的区域编号')),
                ('facility', models.ManyToManyField(to='houses.Facility', verbose_name='和设施表之间是多对多的关系')),
            ],
            options={
                'db_table': 'tb_house',
            },
