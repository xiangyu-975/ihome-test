    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(verbose_name='预订的起始时间')),
                ...
                ('house', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='houses.House', verbose_name='预订的房间编号')),
            ],
            options={
                'db_table': 'tb_order',
            },
